...
public class adminpanel extends AppCompatActivity {
    ...
    private Button AdminManageSystemInventory;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminManageSystemInventory = findViewById(R.id.btn_user_manage_system_inventory);


        AdminManageSystemInventory.setOnClickListener(new View.OnClickListener(){
