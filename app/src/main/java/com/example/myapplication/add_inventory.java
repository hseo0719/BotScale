            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (con == null) {
                        ...
                        String query = "INSERT INTO" + Refrence.ServerDatabaseInv + "(SKU, ItemName, itemDescrip, itemQuant, UOM) VALUES ('"+str_itemSKU+ "', '"+ str_itemName+ "', '"+str_itemDesc+ "', '"+str_itemQTY+ "', '"+str_itemUOM+"')";
